...
function CardView({
    ...
    return (
        <div className="w-full lg:w-5/6 mx-auto">
            ...
            {urls?.length === 0 ? (
                <div className="w-full min-h-[260px] flex items-center justify-center rounded-xl border border-zinc-200 bg-white dark:bg-[#101522] dark:border-zinc-700/70">
                    <div className="flex flex-col items-center justify-center text-center px-6 py-10">

                        <div className="flex items-center justify-center w-14 h-14 rounded-full bg-sky-50 dark:bg-blue-500/10 mb-4">
                            <IoIosLink className="text-2xl text-sky-400 dark:text-blue-500" />
                        </div>
                        ...
                        <p className="mt-1.5 max-w-sm text-sm text-zinc-400 dark:text-zinc-500">
                            There are no shortened URLs to display here yet.
                        </p>
                                    ...
                                    <div className="flex flex-col flex-wrap gap-1.5 mt-4">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {item.tags.map((tag, index) => (
                                                <p
                                                    key={index}
                                                    className="inline-flex items-center gap-2 px-2 py-1 rounded-md text-xs font-medium bg-zinc-100 dark:bg-[#1C283F] text-gray-600 dark:text-gray-200"
                                                >
